...
def run_incremental_pipeline(
    ...
    try:
        ...
        quality_results = run_quality_checks(config_path=config_path, profile=profile, batch_id=batch_id, spark=spark)
        ...
        silver_results = run_silver_transformations(config_path=config_path, profile=profile, batch_id=batch_id, spark=spark)
        stages["silver"] = summarize_results(silver_results)

        gold_results = run_gold_kpis(config_path=config_path, profile=profile, batch_id=batch_id, spark=spark)
